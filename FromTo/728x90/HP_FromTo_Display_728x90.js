...
lib.ssMetadata = [
		{name:"HP_FromTo_Display_728x90_atlas_P_1", frames: [[0,0,1320,270]]},
		{name:"HP_FromTo_Display_728x90_atlas_NP_1", frames: [[0,182,460,180],[0,0,472,180]]}
];
...
(lib._728x90poly = function() {
	this.initialize(ss["HP_FromTo_Display_728x90_atlas_NP_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();



(lib._728x90tofrom1 = function() {
	this.initialize(ss["HP_FromTo_Display_728x90_atlas_NP_1"]);
	this.gotoAndStop(1);
}).prototype = p = new cjs.Sprite();
...
(lib.HealthPointLogo = function() {
	this.initialize(ss["HP_FromTo_Display_728x90_atlas_P_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._728x90tofrom1();
...
}).prototype = getMCSymbolPrototype(lib.PIC1, new cjs.Rectangle(-472,0,472,180), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-77.1,39.7);
	...
	this.shape_1.setTransform(-94.775,39.7);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#8D8B00").s().p("AAvBcIgNghIhFAAIgNAhIg0AAIBMi3IAwAAIBNC3gAAUAUIgUgzIgUAzIAoAAg");
	this.shape_2.setTransform(-115.05,39.625);
	...
	this.shape_3.setTransform(-133.675,39.7);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#8D8B00").s().p("AgYBbIAAhEIhGhxIA6AAIAlBDIAlhDIA4AAIhEBwIAABFg");
	this.shape_4.setTransform(135.2,13.7);
	...
	this.shape_5.setTransform(116.525,13.7);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#8D8B00").s().p("AAqBbIhNhjIAABjIgyAAIAAi1IAvAAIBKBfIAAhfIAyAAIAAC1g");
	this.shape_6.setTransform(96.6,13.7);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#8D8B00").s().p("AAvBcIgMghIhGAAIgNAhIg0AAIBMi3IAwAAIBNC3gAAUAUIgUgzIgUAzIAoAAg");
	this.shape_7.setTransform(76.1,13.625);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#8D8B00").s().p("AAqBbIhNhjIAABjIgyAAIAAi1IAvAAIBKBfIAAhfIAyAAIAAC1g");
	this.shape_8.setTransform(55.55,13.7);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#8D8B00").s().p("Ag7BEQgdgbAAgoIAAgBQAAgnAcgbQAcgbApgBQArAAAfAaIgeAkQgUgQgYgBQgSABgOAOQgNAOAAAUIAAABQAAAVANAPQAOAOAVAAQASAAALgHIAAgXIgkAAIAAgjIBUAAIAABQQgiAdgtgBQgqAAgbgag");
	this.shape_9.setTransform(35.3,13.7);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#8D8B00").s().p("AhJBbIAAi1ICSAAIAAAqIhgAAIAAAcIBWAAIAAAoIhWAAIAAAcIBhAAIAAArg");
	this.shape_10.setTransform(17.05,13.7);
	...
	this.shape_11.setTransform(-0.625,13.7);
	...
	this.shape_12.setTransform(-18.775,13.7);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#8D8B00").s().p("AAvBbIAAhoIgvBGIAAAAIguhFIAABnIgyAAIAAi1IA2AAIAqBGIAshGIA1AAIAAC1g");
	this.shape_13.setTransform(-46.525,13.7);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#8D8B00").s().p("AhFBDQgcgbAAgnIAAgBQAAgnAcgbQAcgbApgBQAqABAcAbQAcAbAAAnIAAAAQAAAogcAbQgdAcgpgBQgpABgcgcgAggghQgNANgBAUIAAAAQABAUANAPQANAOATAAQAVAAANgOQAMgOAAgUIAAgBQAAgTgNgOQgNgPgUAAQgUAAgMAPg");
	this.shape_14.setTransform(-68.6,13.7);
...
// stage content:
(lib.HP_FromTo_Display_728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_11.setTransform(249.25,58,1.5387,1.5387,0,0,0,0.1,35.1);
	...
	this.instance_12.setTransform(249.2,102,1.5387,1.5387,0,0,0,0.1,35.1);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(39).to({_off:false},0).to({x:249.25,y:58},20,cjs.Ease.quintInOut).wait(45).to({y:144},10,cjs.Ease.quintInOut).to({_off:true},1).wait(159));

	// PIC1
	this.instance_13 = new lib.PIC1();
	this.instance_13.setTransform(628.05,45,0.5,0.5,0,0,0,-199.9,90);
	...
	this.instance_15.setTransform(364,135);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1}]}).to({state:[{t:this.instance_14}]},104).to({state:[{t:this.instance_15}]},10).to({state:[]},1).wait(159));
	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(104).to({_off:false},0).to({_off:true,y:135},10,cjs.Ease.quintInOut).wait(160));

	// BKGD_green_type
	this.instance_16 = new lib.Tween5("synched",0);
	this.instance_16.setTransform(637.45,46);
	this.instance_16._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_16).wait(104).to({_off:false},0).wait(170));

	// BKGD_green
	this.instance_17 = new lib.BKGDgreen();
	this.instance_17.setTransform(627,45,1,1,0,0,0,0,45);
	this.instance_17._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_17).wait(104).to({_off:false},0).wait(170));

	// LOGO
	this.instance_18 = new lib.HPlogowTag();
	this.instance_18.setTransform(426.55,39.8,0.68,0.68,0,0,0,0.2,0);
	...
	this.instance_19.setTransform(527.2,-50,1,1,0,0,0,0,-50);
...
p.nominalBounds = new cjs.Rectangle(-129.2,-40.7,1342.4,349.8);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/HP_FromTo_Display_728x90_atlas_P_1.png", id:"HP_FromTo_Display_728x90_atlas_P_1"},
		{src:"images/HP_FromTo_Display_728x90_atlas_NP_1.jpg", id:"HP_FromTo_Display_728x90_atlas_NP_1"}
	],
	preloads: []
};
