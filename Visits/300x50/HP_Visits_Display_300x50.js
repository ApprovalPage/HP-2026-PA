...
lib.ssMetadata = [
		{name:"HP_Visits_Display_300x50_atlas_P_1", frames: [[0,0,1320,270]]},
		{name:"HP_Visits_Display_300x50_atlas_NP_1", frames: [[0,0,600,100]]}
];
...
(lib._300x50poly = function() {
	this.initialize(ss["HP_Visits_Display_300x50_atlas_NP_1"]);
	this.gotoAndStop(0);
...
(lib.HealthPointLogo = function() {
	this.initialize(ss["HP_Visits_Display_300x50_atlas_P_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
// helper functions:
...
// stage content:
(lib.HP_Visits_Display_300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/HP_Visits_Display_300x50_atlas_P_1.png", id:"HP_Visits_Display_300x50_atlas_P_1"},
		{src:"images/HP_Visits_Display_300x50_atlas_NP_1.jpg", id:"HP_Visits_Display_300x50_atlas_NP_1"}
	],
	preloads: []
};
